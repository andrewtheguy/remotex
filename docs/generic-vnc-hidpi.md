...
otherwise — which is what the swayrx density extension does for a sway desktop
behind the swayrx server, under `subtype = "swayrx"`
([`swayrx-density.md`](swayrx-density.md)).
