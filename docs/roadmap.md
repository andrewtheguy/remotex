...
the VNC connection itself, as a private extension a plain `vnc` target asks
every server for and wlshare answers ([`wlshare-density.md`](wlshare-density.md)). The server reports its
