...
//!
//! Used by both Apple Screen Sharing subtypes, `ard` and `ard-high-performance`
//! (see [`crate::vnc`] and [`crate::vnc_apple`]). Nothing here knows what a
//! rectangle is — it is a transport, and the RFB above it is unchanged.
//!
//! ## How the key arrives
//!
