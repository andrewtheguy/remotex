...
//!
//! Used by the `ard-virtual-display` and `ard-high-performance` subtypes (see
//! [`crate::vnc`] and [`crate::vnc_apple`]). Nothing here knows what a rectangle
//! is — it is a transport, and the RFB above it is unchanged.
//!
//! ## How the key arrives
//!
