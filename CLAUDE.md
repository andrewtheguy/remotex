...
- for e2e tests use tests/*, can start dummy RDP server or vnc server with docker or podman, but never start headless browser because automated tests on browser is flaky
