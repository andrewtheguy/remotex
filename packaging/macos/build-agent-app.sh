...
in System Settings > General > Login Items. It starts with no gateways authorized:
it listens and refuses every connection until a gateway's public key is on its
list.
