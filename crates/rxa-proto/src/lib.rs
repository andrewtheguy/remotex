...
//! - [`noise`] — `Noise_KK_25519_ChaChaPoly_BLAKE2s` handshake helpers
...
mod tests {
    ...
    fn prologue_pins_the_version() {
        ...
        // is the intended failure mode. `rxa/2` is the keypair handshake;
        // `rxa/1` was the pre-shared key it replaced.
        assert_eq!(PROLOGUE, b"rxa/2");
    }
